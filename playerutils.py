...
class CVInputSettings(object):
    ...
    """
    def __init__(self, _stream_location, _stream_id, _resize, _thresh_op, _thresh_sensitivity, _detectionMinimum, _accumulation, _blur_radius, _maskc, _contour_queue, _job_queue, _stripes, _shouldflip):
